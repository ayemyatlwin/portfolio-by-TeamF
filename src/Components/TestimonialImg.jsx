  ...
  return (
    <div className=" h-screen basis-1/2 relative flex justify-start items-center my-10">
      ...
      viewport={{ once: false }}
        ...
        alt=""
        className=" w-[80px] h-[65px] absolute top-5 -left-5 lg:left-0 lg:top-24 xl:top-60 xl:-left-5"
      />
      <motion.img
      ...
      viewport={{ once: false }}
        ...
        alt=""
        className=" w-[150px] h-[150px] absolute -top-10 -right-14 md:-right-28 lg:right-16 lg:top-10 xl:top-44"
      />
      <img
